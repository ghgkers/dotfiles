...
services.xserver={enable=true;windowManager.dwm.enable=true;displayManager.setupCommands=''${pkgs.xorg.xrandr}/bin/xrandr --output DP-2 --mode 1920x1080 --rate 165'';};
