...
services={
  ...
  asusd={enable=true;enableUserService=true;};tlp.enable=true;libinput.enable=true;
...
system.activationScripts.ff.text=''
  ...
  mkdir -p $m
  echo '{"logo":{"type":"kitty-direct","source":"/home/dx3d/Downloads/zam.jpg","width":28,"height":12},"modules":["title","os","kernel","packages","wm","terminal","cpu","memory"]}' > $m/config.jsonc
